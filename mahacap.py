...
def city_page():
    ...
    # City selection dropdown in alphabetical order
    ...
    # --- Basic Information ---
    st.subheader(f"{selected_city} - Basic Information")
    ...
    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:15px; margin-bottom:20px;">
        <div style="border:1px solid #444; background:#222; padding:12px; border-radius:6px;">
            <div style="font-size:13px; color:#bbb;">CAP Status</div>
            <div style="font-size:16px; font-weight:600; color:#fff;">{cap_status}</div>
        </div>
        <div style="border:1px solid #444; background:#222; padding:12px; border-radius:6px;">
        ...
        <div style="border:1px solid #444; background:#222; padding:12px; border-radius:6px;">
            ...
            <div style="font-size:16px; font-weight:600; color:#fff;">{population:,}</div>
        </div>
        <div style="border:1px solid #444; background:#222; padding:12px; border-radius:6px;">
            <div style="font-size:13px; color:#bbb;">Area (sq km)</div>
            <div style="font-size:16px; font-weight:600; color:#fff;">{area:,}</div>
        </div>
        <div style="border:1px solid #444; background:#222; padding:12px; border-radius:6px;">
            <div style="font-size:13px; color:#bbb;">Department Name</div>
            <div style="font-size:14px; color:#fff;">{dept_name}</div>
        </div>
        <div style="border:1px solid #444; background:#222; padding:12px; border-radius:6px;">
            <div style="font-size:13px; color:#bbb;">Department Email</div>
            <div style="font-size:14px; color:#fff;">{dept_email}</div>
        </div>
        <div style="border:1px solid #444; background:#222; padding:12px; border-radius:6px;">
