...
.stSelectbox>div>div{background-color:#1f2937;color:#ffffff;}
.stSlider>div>div>div{background-color:#1f2937;}
</style>
...
# -------------------- Sidebar --------------------
st.sidebar.image(
    "https://github.com/eintrusts/CAP/raw/main/EinTrust%20%20(2).png",
