...
def city_page():
    ...
    cap_status = city_info.get("CAP_Status", "Not Started")
    cap_link = city_info.get("CAP_Link", "")
    total_pop = city_info.get("Population", {}).get("Total", 0)
    ...
    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap:15px; margin-bottom:20px;">
        ...
        <div style="border:1px solid #333; background:#1e1e1e; padding:12px; border-radius:6px;">
            <div style="font-size:13px; color:#bbb;">Population</div>
            <div style="font-size:16px; font-weight:600; color:#fff;">{total_pop:,}</div>
        </div>
        <div style="border:1px solid #333; background:#1e1e1e; padding:12px; border-radius:6px;">
